...
public class TeacherController {
     ...
     * Принимает объект типа {@link MultipartFile} с изображением в теле запроса и параметр id в виде UUID.
     ...
     * Принимает параметры id в виде UUID и position в виде целого числа.
    ...
    /**
     * Возвращает файл изображения для указанного преподавателя по имени файла.
