...
public class PartnerController {
     ...
     * данных изображения {@link MultipartFile} и ID объекта. Возвращает URL обновленного изображения
    ...
    /**
     * Конечная точка для удаления объект типа {@link Partner} на основе переданного UUID-идентификатора
    ...
    /**
     * Конечная точка для получения логотипа для объекта типа {@link Partner} на основе переданного имени файла.
